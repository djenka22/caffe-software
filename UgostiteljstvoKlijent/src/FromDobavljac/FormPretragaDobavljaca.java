...
import models.TableModelDobavljaci;
 ...
 * @author Korisnik
 */
public class FormPretragaDobavljaca extends javax.swing.JDialog {

    public FormPretragaDobavljaca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        TableModelDobavljaci model = new TableModelDobavljaci();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pretraga (naziv dobavljaca):");
        ...
        btnDetalji.setText("Detalji dobavljaca");
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ((TableModelDobavljaci) tblDobavljaci.getModel()).setParametar(param);
    }//GEN-LAST:event_txtPretragaKeyReleased

    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed

        int row = tblDobavljaci.getSelectedRow();

        if (row >= 0) {
            Dobavljac p = ((TableModelDobavljaci) tblDobavljaci.getModel()).getSelectedDobavljac(row);
            new FormDetaljiDobavljaca(this, rootPaneCheckingEnabled, p).setVisible(true);
        }
    ...
    void refreshTable() {
        TableModelDobavljaci tm = (TableModelDobavljaci) tblDobavljaci.getModel();
        tm.refreshTable();
    }
